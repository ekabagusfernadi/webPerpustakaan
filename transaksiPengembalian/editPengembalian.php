...
$queryBukuTersedia = "SELECT data_buku.kode_buku, data_buku.judul_buku
    FROM transaksi_pinjam_buku
    RIGHT JOIN data_buku ON(transaksi_pinjam_buku.kode_buku = data_buku.kode_buku)
    WHERE transaksi_pinjam_buku.kode_buku IS NULL
";
            ...
            <div id="containerTable">
                <form method="post">
                    ...
                    <tr>
                        ...
                        <td>
                            : <select name="noAnggotaPeminjam" id="noAnggotaPeminjam">
                    ...
                    <tr>
                        ...
                        <td>
                            : <select name="kodeBukuDipinjam" id="kodeBukuDipinjam">
